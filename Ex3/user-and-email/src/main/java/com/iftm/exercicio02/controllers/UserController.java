...
public class UserController {
    ...
    @GetMapping("/age")
    public List<UserVO> getUsersByAge(@RequestParam int idade) {
        return service.findByIdade(idade);
    }
    @GetMapping("/name")
    public List<UserVO> getUsersByName(@RequestParam String firstName, @RequestParam String lastName) {
